...
const CssMinimizerPlugin = require('css-minimizer-webpack-plugin'); //Para optimizar CSS
const TerserPlugin = require('terser-webpack-plugin'); //Para optimizar JS
...
module.exports = {
    ...
    optimization: { //Para optimizar el proyecto
        minimize: true,
        minimizer: [
